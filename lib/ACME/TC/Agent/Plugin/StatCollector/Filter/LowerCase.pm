package ACME::TC::Agent::Plugin::StatCollector::Filter::LowerCase;
...
=head1 NAME ACME::TC::Agent::Plugin::StatCollector::Filter::LowerCase

Lowercase all stored statistics keys. This is B<content-only> filter.
